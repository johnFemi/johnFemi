...
<head>
    ...
    <title>Job360/international</title>
...
?>    
    ...
    <form class="row g-3" method="POST">
        <div class="col-md-4">
          ...
          <div class="col-md-6">
            <label for="inputitle" class="form-label">Prefered Country</label>
            <input type="name" name="prefered_country" class="form-control" id="inputName" required value="<?php echo "$preferedCountry";?>">
          </div>
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
              <button type="submit" name="international_package" class="btn btn-primary btn-lg btn-block text-white btn-search"><span class="icon-search icon mr-2"></span>Submit</button>
          </div>
