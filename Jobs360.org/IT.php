...
?>
    ...
    <form class="row g-3" method="POST" enctype="multipart/form-data">
        <div class="col-md-4">
          ...
          <div class="col-md-12">
            <label for="inputitle" class="form-label">IT Letter <small style="color:gray;">Max. 5mb (png, jpg, jpeg and pdf)</small></label>
                  <input type="file" name="it" class="form-control" id="inputCv" accept=".doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document" required>

          </div>
           
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
              <button type="submit" name="it_package" class="btn btn-primary btn-lg btn-block text-white btn-search"><span class="icon-search icon mr-2"></span>Submit</button>
          </div>
