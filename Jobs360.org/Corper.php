...
?>
    ...
    <form class="row g-3" method="POST" enctype="multipart/form-data">
        <div class="col-md-4">
          ...
          <div class="col-md-6">
            <label for="inputCity" class="form-label">City Of Service</label>
            <input type="text" name="city_of_service" class="form-control" id="inputCity" required value="<?php echo "$cityOfService";?>">
          </div>
          <div class="col-md-6">
            <label for="inputState" class="form-label">State Of Service</label>
            <input type="text" name="state_of_service" class="form-control" id="inputstate" required value="<?php echo "$stateOfService";?>">
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <label for="inputitle" class="form-label">Cv Review <small style="color:gray;">Max. 5mb (png, jpg, jpeg and pdf)</small></label>
                  <input type="file" name="cv" class="form-control" id="inputCv" accept=".doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document" required>

          </div>
           
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
              <button type="submit" name="corper_package" class="btn btn-primary btn-lg btn-block text-white btn-search"><span class="icon-search icon mr-2"></span>Submit</button>
          </div>
