...
?> 
    <form class="row g-3" method="POST" enctype="multipart/form-data">
       <h3 style="text-align:center;">Local Package Registration</h3>
        <div class="col-md-4">
          ...
          <div class="col-md-6">
            <label for="inputitle" class="form-label">Cv Review (PDF File)</label>
                  <input type="file" name="cv" class="form-control" id="inputCv" required>
          </div>

            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
              <button type="submit" name="local_package" class="btn btn-primary btn-lg btn-block text-white btn-search"><span class="icon-search icon mr-2"></span>Submit</button>
          </div>
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1027710408254833"
    crossorigin="anonymous"></script>
